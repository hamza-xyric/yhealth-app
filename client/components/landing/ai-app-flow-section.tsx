    ...
    <section ref={sectionRef} className="py-12 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-1 sm:gap-2 mb-6 sm:mb-8 overflow-x-auto pb-2 scrollbar-hide">
          ...
          <div className="max-w-md mx-auto mt-4 sm:mt-6">
            <div className="h-1 bg-muted/20 rounded-full overflow-hidden">
              <motion.div
                ...
                initial={{ width: "0%" }}
                animate={{
                  width: `${((activeStep + 1) / appFlowSteps.length) * 100}%`,
                }}
                transition={{ duration: 0.3 }}
              />
            </div>
